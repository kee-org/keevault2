...
//    
//    internal override func processXmlKeyFile(keyFileData: ByteArray) throws -> ByteArray? {
//        let xml: AEXMLDocument
//        do {
//            xml = try AEXMLDocument(xml:  Data(
//                                    bytesNoCopy: keyFileData,
//                                    count: keyFileData.count,
//                                    deallocator: .none
//                                ))
//        } catch {
//            return nil
...
//    }
//    
//    private func processXMLFileVersion1(_ xml: AEXMLDocument) throws -> ByteArray? {
...
//        }
//        return ByteArray.from(keyData)
//    }
//    
//    private func processXMLFileVersion2(_ xml: AEXMLDocument) throws -> ByteArray? {
