...
//                            if Logger.mainLog.isDeepDebugMode() {
//                                Logger.mainLog.debug("Encrypted field value: `\(encData.asHexString)`")
//                                Logger.mainLog.debug("Decrypted field value: `\(plainData.asHexString)`")
//                            }
                        }
                    }
                } else {
