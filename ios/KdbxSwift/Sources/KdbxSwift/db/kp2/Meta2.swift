    ...
    func load(
        ...
        for tag in xml.children {
            ...
            case Xml2.generator:
                ...
                Logger.mainLog.info("Database was last edited by: \(self.generator)")
            case Xml2.settingsChanged: 
                guard formatVersion >= .v4 else {
                    Logger.mainLog.error("Found \(tag.name) tag in non-V4 database")
            ...
            case Xml2.headerHash:
                    Logger.mainLog.warning("Found \(tag.name) tag in non-V3 database. Ignoring")
                    continue
            ...
            case Xml2.customIcons:
                ...
                Logger.mainLog.trace("Custom icons loaded OK [count: \(self.customIcons.count)]")
            ...
            case Xml2.binaries:
                ...
                Logger.mainLog.trace("Binaries loaded OK [count: \(self.database.binaries.count)]")
            case Xml2.customData:
                ...
                Logger.mainLog.trace("Custom data loaded OK [count: \(self.customData.count)]")
            default:
