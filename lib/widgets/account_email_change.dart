                                ...
                                try {
                                  ...
                                  if (result) {
                                    ...
                                    await AppConfig.router.navigateTo(
                                        AppConfig.navigatorKey.currentContext!, Routes.root,
                                        clearStack: true);
                                  }
                                } finally {
                                  if (mounted) {
