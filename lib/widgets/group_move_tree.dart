    ...
    return BlocBuilder<VaultCubit, VaultState>(
      ...
      builder: (context, state) {
        if (state is VaultLoaded) {
          ...
          return GroupMoveTreeListWidget(nodes: nodes, initialSelectedUuid: initialSelectedUuid, title: title);
        }
        return Container();
      },
    );
...
abstract class MoveTreeListWidget extends StatefulWidget {
  ...
  final String title;
  const MoveTreeListWidget({super.key, required this.nodes, required this.title});
}
...
class EntryMoveTreeListWidget extends MoveTreeListWidget {
  const EntryMoveTreeListWidget({super.key, required super.nodes, required super.title});
