...
class _SettingsWidgetState extends State<SettingsWidget> with TraceableClientMixin {
  ...
  void changePassword() async {
    if (BlocProvider.of<VaultCubit>(context).beginChangePasswordIfPossible()) {
      await AppConfig.router.navigateTo(context, Routes.changePassword, transition: TransitionType.inFromRight);
    }
  }
      ...
      builder: (context, accountState) {
        ...
        if (accountState is AccountChosen) {
          ...
          if (userEmail != null) {
            ...
            accessChildren.add(
              SimpleSettingsTile(title: str.changePassword, subtitle: str.changePasswordDetail, onTap: changePassword),
            );
            accessChildren.add(
              SettingsContainer(
                children: [
              ...
              child: Theme(
                ...
                child: SettingsScreen(
                  ...
                  children: [
                    ...
                    SettingsGroup(
                      title: str.quickSignIn,
                      children: [BiometricSettingWidget(isEnabledOnDevice: _isDeviceQuickUnlockEnabled)],
                    ),
                    SettingsGroup(
                      ...
                      children: [
                        ...
                        SimpleSettingsTile(
                          ...
                          child: Theme(
                            data: Theme.of(context).copyWith(scaffoldBackgroundColor: Theme.of(context).canvasColor),
                            child: SettingsScreen(title: 'Access / Recovery', children: <Widget>[...accessChildren]),
                          ),
                        ),
                        SimpleSettingsTile(
                        ...
                        BlocBuilder<AppRatingCubit, AppRatingState>(
                          builder: (context, appRatingState) {
    ...
    final quickUnlockSettings = [
      TextInputSettingsTile(
        ...
        onChange: (_) async {
          ...
          await vaultCubit.enableQuickUnlock(user, vaultCubit.currentVaultFile?.files.current);
        },
...
class AutofillStatusWidget extends StatefulWidget {
  ...
  const AutofillStatusWidget({super.key, required this.isEnabled, required this.isDeviceQuickUnlockEnabled});
                ...
                child: FilledButton(
                  ...
                  onPressed: () async {
                    ...
                    await DialogUtils.showSimpleAlertDialog(
                      context,
                      str.enableAutofill,
                      str.enableAutofillIosInstructions(_packageInfo.appName),
