...
var vaultHandler = Handler(
  handlerFunc: (BuildContext? context, Map<String, List<String>> params) {
    return const VaultWidget();
  },
);

var passwordGeneratorHandler = Handler(
  handlerFunc: (BuildContext? context, Map<String, List<String>> params) {
    return const PasswordGeneratorWidget();
  },
);

var importExportHandler = Handler(
  handlerFunc: (BuildContext? context, Map<String, List<String>> params) {
...
var passwordPresetManagerHandler = Handler(
  handlerFunc: (BuildContext? context, Map<String, List<String>> params) {
...
var changeEmailPrefsHandler = Handler(
  handlerFunc: (BuildContext? context, Map<String, List<String>> params) {
    return const ChangeEmailPrefsWidget();
  },
);

var changeSubscriptionHandler = Handler(
  handlerFunc: (BuildContext? context, Map<String, List<String>> params) {
